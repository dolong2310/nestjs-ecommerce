...
- Chỉ có Role Admin mới được cập nhật user với roleld là admin, hoặc lên cấp role thành admin
- Bạn không thể cập nhật chính mình

## Xóa user: DELETE /users/:userId

- Chỉ có Role Admin mới được xóa user với roleld là admin
