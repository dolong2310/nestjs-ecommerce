import { CreateUserBodySchema, CreateUserResponseSchema, GetUserResponseSchema, GetUsersResponseSchema, UpdateUserBodySchema, UpdateUserResponseSchema, UserParamsSchema, UserQuerySchema } from "@/routes/user/user.model";
